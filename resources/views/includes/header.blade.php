 <header class="main-header">
    ...
    <a href="{{ route('home') }}" class="logo">
      ...
      <span class="logo-mini"><img src="{!! asset('img/short_logo.png') !!}" width="380px"  alt="Company Logo"></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><img src="{!! asset('img/Data_phrame_logo.png') !!}" width="380px"  alt="Company Logo"></span>
    </a>
      ...
      <div class="navbar-custom-menu">
        ...
        @if(!empty(Auth::user()->profile_image))
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="{{ asset($user_profile ) }}" class="user-image" alt="User Image">
